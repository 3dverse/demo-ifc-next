...
export const EnergyView = memo(() => {
    return (
        <aside
            className="absolute bottom-16 lg:top-14 right-4
        ...
        >
            <header className="flex flex-row justify-between px-4 pt-2">
                <div className="w-full flex flex-row justify-between gap-4 items-center">
                    ...
                    <p className="flex flex-row justify-center gap-1 font-light text-xs rounded-full bg-red-100 text-increase px-1 w-[5rem]">
